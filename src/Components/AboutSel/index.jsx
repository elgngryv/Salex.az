...
const AboutSel = () => {
  return (
    <div className="mt-[130px] md:mt-[363px] px-4 text-[#3D246A] md:flex md:flex-col md:items-center md:text-center md:justify-center md:w-full openSans">
      {/* Text box */}
      <div className="w-full  md:w-[606px] border border-white/30 shadow-[0_4px_30px_rgba(0,0,0,0.1)] bg-gradient-to-r from-white/10 via-white/5 to-white/10 backdrop-blur-[10px] backdrop-saturate-150 rounded-[20px]">
      ...
      {/* Desktop */}
      <img
        className="hidden bottom-[100px]  md:block mt-[-598px] mx-auto"
