...
const AboutMain = () => {
  return (
    <div className=" md:container md:max-w-[1336px] md:mx-auto">
      <div className="relative w-full top-[100px] mb-[800px]  md:bottom-[-400px] md:mb-[1000px] ">
        ...
        <div className="absolute bottom-[185px] md:bottom-[214px] md:left-[560px] left-1/2 transform -translate-x-1/2 z-20 px-4 w-full max-w-md">
