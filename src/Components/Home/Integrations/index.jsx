        ...
        <div className="flex md:flex flex-col gap-4 ">
          <div className="md:flex md:gap-4    md:items-center md:justify-center">
            ...
            <div
              ...
              data-aos-offset="800"
              className="w-full  md:w-[310px] text-[#3D246A] border border-white/30 shadow-[0_4px_30px_rgba(0,0,0,0.1)] bg-gradient-to-r from-white/10 via-white/5 to-white/10 backdrop-blur-[10px] backdrop-saturate-150 rounded-[20px] flex items-center text-center justify-center py-[23px] gap-[7px]">
