...
const SalexSection = () => {
  return (
    <div className="p-4 mt-[72px]  md:flex md:flex-col md:items-center md:text-center md:justify-center md:w-full openSans">
      <div
        className="w-full md:py-[24px] md:px-4 md:w-[606px]  border border-white/30 shadow-[0_4px_30px_rgba(0,0,0,0.1)] bg-gradient-to-r from-white/10 via-white/5 to-white/10 backdrop-blur-[10px] backdrop-saturate-150  rounded-[20px]"
        data-aos="fade-up"
