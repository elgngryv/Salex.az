...
const AboutSection = () => {
  return (
    <div className="p-[42px] md:container md:max-w-[1336px] md:mx-auto mt-[40px] md:px-[330px]">
      <div className="border p-[20px] leading-[100%] md:w-[717px]  border-white/20 bg-white/10 backdrop-blur-md shadow-md rounded-[20px]   relative z-10">
        <div className="openSans px-4 md:max-w-[717px] md:p-[42px] md:mx-auto md:text-[16px] md:leading-[28px]">
          <div className="mb-4">
            <h2 className="text-[#3D246A] dark:text-[#E1DCE6] text-sm md:text-base leading-relaxed">
              <span className="font-bold dark:text-[#E1DCE6] text-base md:text-lg leading-[100%]">
                Missiyamız
              </span>{" "}
