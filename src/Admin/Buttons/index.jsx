      ...
      >
        ...
        >
          <path
            ...
            fill={iconColor}
          />
          <circle cx="7" cy="9" r="1" fill={iconColor} />
          <circle cx="12" cy="9" r="1" fill={iconColor} />
          <circle cx="17" cy="9" r="1" fill={iconColor} />
        </svg>
      </button>

      {/* Düymənin altında rəng seçici */}
      <div className="flex flex-col items-center gap-4 bg-white p-4 rounded-xl shadow-md">
        <div className="flex flex-col items-center gap-2">
          <label className="text-sm">Fon Rəngi:</label>
          <input
            type="color"
            value={tempBg}
        ...
        <div className="flex flex-col items-center gap-2">
          <label className="text-sm">İkon Rəngi:</label>
          <input
            type="color"
            value={tempIcon}
